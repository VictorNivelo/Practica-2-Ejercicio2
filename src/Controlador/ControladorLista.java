...
public class ControladorLista extends InterfazPrincipal{ 
    ...
    ListaEnlazada<Restaurante> platos = new ListaEnlazada<>();
    
    public void crearRestaurante(){
        for (int i = 0; i < 20; i++) {
            getRestaurante().insertar(new Restaurante(txtEntrada.getText(), txtSopas.getText(), txtPlatosFuertes.getText(), txtPlatosSegundarios.getText(), txtPostres.getText()));
        }
//        
//        getRestaurante().insertar(new Restaurante("","","","",""));
//        getRestaurante().insertar(new Restaurante("","","","",""));
//        getRestaurante().insertar(new Restaurante("","","","",""));
//        getRestaurante().insertar(new Restaurante("","","","",""));
//        getRestaurante().insertar(new Restaurante("","","","",""));
...
//        getRestaurante().insertar(new Restaurante("","","","",""));
    ...
    public ListaEnlazada<Restaurante> getRestaurante() {
        return platos;
    }

    public void setRestaurante(ListaEnlazada<Restaurante> restaurantes) {
        this.platos = restaurantes;
    }
